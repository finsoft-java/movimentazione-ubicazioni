...
/**
     ...
     */
    function richiestaMovimentazione($riga) {
      ...
      for($i = 0 ; $i < count($riga["PRELIEVI"]); $i++){
          ...
          $sql = "INSERT INTO THIP.DOC_TRA_RIG (
              DATA_ORIGIN,              -- 1
              RUN_ID,
              ROW_ID,
              RUN_ACTION,
